...
```console
vitruvio source scaffold courseware     # writes ~/.config/vitruvio/sources/courseware.py
$EDITOR ~/.config/vitruvio/sources/courseware.py
vitruvio --project coursework --brain optics source add course \
  --kind courseware --option course_id=77
vitruvio --project coursework --brain optics source pull course
```
